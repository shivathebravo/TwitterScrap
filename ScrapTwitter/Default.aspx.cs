...
namespace ScrapTwitter
{
    public partial class _Default : Page
    {
        ...
        private string GetFollowing(string username)
        {
            ...
            HtmlAgilityPack.HtmlDocument htmlDoc = webGet.Load("https://mobile.twitter.com/" + username +"/following");
            htmlDoc.OptionFixNestedTags = true;
            string classToFind = "fullname";
            ...
            if (allElementsWithClassFloat != null)
            {
                ...
                var urlString = "https://mobile.twitter.com/"+username+"/following?cursor=";
